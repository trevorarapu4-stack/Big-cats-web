<template>
    <div class="top" :style="{
        backgroundImage: `linear-gradient(rgba(0, 0, 0, ${darknessLevel}), rgba(0, 0, 0, ${darknessLevel})), url(${forSingleItineraryData?.image})`,
...
const darknessLevel = 0.7 // 0 = no darkness, 1 = completely black
