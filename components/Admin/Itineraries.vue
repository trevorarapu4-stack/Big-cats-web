<template>
    <div class="itineraries">
        ...
        <empty-section section="Itineraries" v-else />
        <div class="addButton">
            <UButton @click="adminComponent = 'Add Itinerary'" icon="solar:add-circle-bold-duotone"
        ...
        <UModal v-model:open="isDeleteModal" :ui="{ footer: 'justify-end' }">
            <template #header>
                <div class="to">
                    ...
                    <p>Would you like to delete the itinerary {{ docToDelete?.title }}.</p>
                </div>
            </template>
